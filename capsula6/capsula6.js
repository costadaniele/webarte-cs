//var url6 = "https://ia801504.us.archive.org/8/items/capsulassonoras/cs06_31R3.mp3"
...
function setup() {
  ...
  //song1 = loadSound(url6, loaded);
  //song = song1;
  song = loadSound("/CAPSULAS_MP3/cs06_31R3.mp3", loaded);
  background(0);
  toggleSliders();

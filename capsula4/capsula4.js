//var url4 = 'https://ia601504.us.archive.org/8/items/capsulassonoras/cs04_29C1.mp3'
...
function setup() {
  ...
  //song1 = loadSound(url4, loaded);
  song = loadSound("/CAPSULAS_MP3/cs04_29C1.mp3", loaded);
 // song = song1;
  background(0);
  toggleSliders();
